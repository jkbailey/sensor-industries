...
(function() {
  this.Dashboard = (function(Backbone, Marionette, $) {
    var App;
    App = new Marionette.Application;
    App.on('before:start', function() {
      return App.user = App.request('entities:user');
    });
...
window.JST["components/company_profile/templates/contact"] = function (__obj) {
  if (!__obj) __obj = {};
...
window.JST["components/company_profile/templates/profile"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<h1>Parent Company Profile</h1>\n\n<div class="form-container vertical-layout company-form">\n  <h3>Parent Company Information</h3>\n  <div class="form-row">\n    <label for="companyName">Name:</label>\n    <div class="input-container long"><input type="text" name="companyName" id="companyName" placeholder="Sensor Industries Inc."></div>\n  </div>\n  <div class="form-row">\n    <label for="phone">Phone:</label>\n    <div class="input-container phone"><input type="text" name="phone" id="phone" placeholder="(805) 987-6543"></div>\n  </div>\n  <div class="form-row">\n    <label for="address">Address:</label>\n    <div class="input-container long"><input type="text" name="address" id="address" placeholder="1234 Sensor st."></div>\n  </div>\n  <div class="form-row">\n    <label for="city">City:</label>\n    <div class="input-container long"><input type="text" name="city" id="city" placeholder="Camarillo"></div>\n  </div>\n  <div class="form-row">\n    <label for="state">State:</label>\n    <div class="input-container short"><div class="state-dropdown-container company-state"></div></div>\n  </div>\n  <div class="form-row">\n    <label for="zip">Zip:</label>\n    <div class="input-container short"><input type="text" name="zip" id="zip" placeholder="93010"></div>\n  </div>\n</div>\n\n<div class="form-container vertical-layout">\n  <h3>Parent Company\'s Point of Contact</h3>\n  <ul class="contacts-list"></ul>\n  <div class="form-row text-btn-container">\n    <a class="text-btn add-contact">Add an additional point of contact</a>\n  </div>\n</div>\n\n<div class="form-row button-row">\n  <button class="btn primary save auto-size">Save & Continue</button>\n</div>\n');
...
window.JST["components/header/templates/header"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<h1>Sensor Industries</h1>\n\n<ul class="complex-nav">\n  <li><a href="#complex-profile" class="profile">Profile</a></li>\n  <li><a href="#units" class="units">Units</a></li>\n  <li><a href="#alerts" class="alerts">Alerts</a></li>\n</ul>\n\n<div class="user">\n  <div class="name"><span>Complex Name</span></div>\n  <ul>\n    <li><a href="#company-profile">Company Profile</a></li>\n    <li><a href="#complexes">Switch Complex</a></li>\n    <li><a href="#sign-out" class="sign-out">Sign Out</a></li>\n  </ul>\n</div>\n\n<div class="global-error"></div>\n');
...
window.JST["components/login/templates/form"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<div class="login-container">\n  <div class="logo">\n\n    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"\n    \t width="80px" height="120.728px" viewBox="103.546 38.727 80 120.728" enable-background="new 103.546 38.727 80 120.728"\n    \t xml:space="preserve">\n    <path fill="#FFFFFF" d="M172.055,89.636c-9.018-15.127-21.09-32.582-28.509-50.909c-7.418,18.328-19.491,35.782-28.509,50.909\n    \tc-6.254,10.618-11.491,17.019-11.491,29.964c0,21.963,17.891,39.855,40,39.855s40-17.892,40-39.855\n    \tC183.546,106.654,178.31,100.108,172.055,89.636z M141.736,149.938c-13.013-0.138-27.411-13.706-27.549-27.134\n    \tc-0.062-5.963,0.026-10.325,2.354-14.398c7.752,25.058,18.378,34.631,45.546,35.026C156.549,148.416,149.3,150.019,141.736,149.938z\n    \t"/>\n    </svg>\n\n  </div>\n  <h1>Sign&nbsp;in&nbsp;to Sensor&nbsp;Industries&nbsp;Inc.</h1>\n  <div class="form-container clear">\n    <div class="form-row login-error">\n      <span class="error-text">The username or password you entered was incorrect, please try again.</span>\n    </div>\n    <div class="form-row">\n      <input type="text" name="userName" id="userName" placeholder="Username" class="no-border">\n    </div>\n    <div class="form-row">\n      <input type="password" name="password" id="password" placeholder="Password" class="no-border">\n    </div>\n  </div>\n  <div class="form-row button-row">\n    <button class="btn primary big outline">Sign In</button>\n  </div>\n</div>\n');
...
window.JST["components/unit_list/templates/layout"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
...
window.JST["components/unit_list/templates/sensor"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<span class="small-label">Sensor Type:</span>\nSensor ID\n');
...
window.JST["components/unit_list/templates/unit"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  (function() {
    (function() {
      __out.push('<div class="left-side">\n  <div class="form-row">\n    <div class="half-row unit-left-first-col">\n      <label for="unitNumber">Unit:</label>\n      <input type="text" id="unitNumber" name="unitNumber" placeholder="1534" class="input-small">\n    </div>\n    <div class="half-row unit-left-second-col">\n      <label for="bedrooms">Bedrooms:</label>\n      <input type="text" id="bedrooms" name="bedrooms" placeholder="2" class="input-small">\n    </div>\n  </div>\n  <div class="form-row">\n    <div class="half-row unit-left-first-col">\n      <label for="tenants">Tenants:</label>\n      <input type="text" id="tenants" name="tenants" placeholder="3" class="input-small">\n    </div>\n    <div class="half-row unit-left-second-col">\n      <label for="bathrooms">Bathrooms:</label>\n      <input type="text" id="bathrooms" name="bathrooms" placeholder="2" class="input-small">\n    </div>\n  </div>\n  <div class="form-row">\n    <div class="full-row">\n      <label for="unit_node">Unit Node:</label>\n      <input type="text" id="unit_node" name="unit_node" placeholder="unit_node" class="">\n    </div>\n  </div>\n</div>\n\n<div class="right-side">\n  <h5>Sensors</h5>\n  <div class="list-sensors"></div>\n</div>\n\n<div class="edit-bar">\n  <button class="btn add add-sensor">Add Sensor</button>\n  <button class="btn cancel">Cancel</button>\n  <button class="btn save">Save</button>\n</div>\n');
...
window.JST["root/templates/layout"] = function (__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
...
(function() {
  this.Dashboard.module('Concerns', function(Concerns, App, Backbone, Marionette, $, _) {
    return Concerns.EnterPress = {
      keyboardEvents: {
        'enter': 'enterPressed'
      },
      onRender: function() {
        return this.$('input').addClass('mousetrap');
      },
...
(function() {
  this.Dashboard.module('Concerns', function(Concerns, App, Backbone, Marionette, $, _) {
    return Concerns.Serialize = {
      getFormDataContainer: function() {
        if (this.formContainer) {
          return this.$(this.formContainer);
        } else {
          return this.$el;
        }
      },
      serialize: function() {
        return Backbone.Syphon.serialize(this.getFormDataContainer());
      },
      onRender: function() {
        return Backbone.Syphon.deserialize(this.getFormDataContainer(), this.model.attributes);
      }
    };
  });
...
(function() {
  this.Dashboard.module('Concerns', function(Concerns, App, Backbone, Marionette, $, _) {
    return Concerns.StateDropdown = {
      ...
      addStateDropdowns: function(container, name) {
        var dropdown;
        dropdown = ["<select id='" + name + "' name='" + name + "'>"];
        dropdown.push("<option value=''>--</option>");
        _.each(this.states, function(long, short) {
          return dropdown.push("<option value='" + short + "'>" + short + "</option>");
        });
        dropdown.push("</select>");
        return this.$(container).html(dropdown.join(''));
      }
    };
  });
...
(function() {
  this.Dashboard.module('Concerns', function(Concerns, App, Backbone, Marionette, $, _) {
    return Concerns.Validation = {
      ...
      onRender: function() {
        this.getFormDataContainer().find(':input').on('focus', (function(_this) {
          return function() {
            return _this.hideErrors();
          };
        })(this));
        return this.getFormDataContainer().find(':input').on('blur', (function(_this) {
          return function() {
      ...
      preValidate: function() {
        var errors;
        if (errors = this.model.preValidate(this.serialize())) {
          return this.model.trigger('validated:invalid', errors);
        }
      }
    };
  });
...
(function() {
  ...
  this.Dashboard.module("Utilities", function(Utilities, App, Backbone, Marionette, $, _) {
    var i, include, j, key, klass, klasses, len, len1, mixinKeywords, module, modules, obj;
    mixinKeywords = ["beforeIncluded", "afterIncluded"];
    include = function() {
      var concern, i, klass, len, obj, objs, ref, ref1, ref2;
      objs = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      klass = this;
      for (i = 0, len = objs.length; i < len; i++) {
        obj = objs[i];
        concern = App.request("concern", obj);
        if ((ref = concern.beforeIncluded) != null) {
          ref.call(klass.prototype, klass, concern);
        }
        Cocktail.mixin(klass, (ref1 = _(concern)).omit.apply(ref1, mixinKeywords));
        if ((ref2 = concern.afterIncluded) != null) {
          ref2.call(klass.prototype, klass, concern);
        }
      }
      return klass;
    };
    ...
    return App.reqres.setHandler('concern', function(concern) {
...
(function() {
  this.Dashboard.module("Utilities", function(Utilities, App, Backbone, Marionette, $, _) {
    ...
    return Backbone.sync = function(method, model, options) {
      ...
      if (App.user) {
        options.beforeSend = function(xhr) {
          return xhr.setRequestHeader("Authorization", "Basic " + (App.user.get('auth_string')));
        };
      }
      if ((model != null) && (method === 'create' || method === 'update' || method === 'delete')) {
      ...
      options.error = function(xhr, textStatus, errorThrown) {
        ...
        if (error) {
          return error.call(xhr, textStatus, errorThrown);
        }
      };
      sync = _sync.call(this, method, model, options);
...
(function() {
  ...
  this.Dashboard.module("Components.CompanyProfile", function(CompanyProfile, App, Backbone, Marionette, $, _) {
    CompanyProfile.Controller = (function(superClass) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(this.companyProfileLayout, 'destroy', (function(_this) {
          return function() {
    ...
    return App.reqres.setHandler("company:profile", function(options) {
      if (options == null) {
        options = {};
      }
      return new CompanyProfile.Controller(options);
    });
  });
...
(function() {
  ...
  this.Dashboard.module("Components.CompanyProfile", function(CompanyProfile, App, Backbone, Marionette, $, _) {
    CompanyProfile.Contact = (function(superClass) {
    ...
    return CompanyProfile.Layout = (function(superClass) {
      ...
      Layout.prototype.template = JST['components/company_profile/templates/profile'];

      Layout.prototype.childView = CompanyProfile.Contact;

      Layout.prototype.childViewContainer = '.contacts-list';

      Layout.prototype.formContainer = '.company-form';
      ...
      Layout.prototype.onRender = function() {
        return this.addStateDropdowns('.company-state', 'state');
      };

      Layout.prototype.modelIsInvalid = function() {
        return console.log('is invalid');
      };

      Layout.include('StateDropdown', 'Serialize', 'Validation');
...
(function() {
  ...
  this.Dashboard.module("Components.ComplexProfile", function(ComplexProfile, App, Backbone, Marionette, $, _) {
    ComplexProfile.Controller = (function(superClass) {
      extend(Controller, superClass);
    ...
    return App.reqres.setHandler("complex:profile", function(options) {
      if (options == null) {
        options = {};
      }
      return new ComplexProfile.Controller(options);
    });
  });
...
(function() {
  ...
  this.Dashboard.module("Components.Header", function(Header, App, Backbone, Marionette, $, _) {
    Header.Controller = (function(superClass) {
      extend(Controller, superClass);
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.region = (options || {}).region;
        this.headerLayout = new Header.Layout();
        this.listenTo(this.headerLayout, 'show', (function(_this) {
          return function() {
            return _this.setUserBox();
          };
        })(this));
        this.listenTo(App.vent, 'global:error', (function(_this) {
          return function(message) {
            return _this.headerLayout.showError(message);
          };
        })(this));
        return this.region.show(this.headerLayout);
      };

      Controller.prototype.onNavigate = function(route) {
        this.setUserBox();
        return this.setSelectedRoute(route);
      };

      Controller.prototype.setUserBox = function() {
        var ref, ref1;
        if (App.selectedComplex && App.selectedComplex.get('name')) {
          return this.headerLayout.updateUserBoxText(App.selectedComplex.get('name'));
        } else if (((ref = App.company) != null ? ref.isSetUp() : void 0) && App.company.get('name')) {
          return this.headerLayout.updateUserBoxText(App.company.get('name'));
        } else if ((ref1 = App.company) != null ? ref1.isSetUp() : void 0) {
          return this.headerLayout.updateUserBoxText('0123456789');
        }
      };

      Controller.prototype.setSelectedRoute = function(route) {
        switch (route) {
          case 'complex-profile':
            return this.headerLayout.updateNav('profile');
          case 'units':
            return this.headerLayout.updateNav('units');
          case 'alerts':
            return this.headerLayout.updateNav('alerts');
          default:
            return this.headerLayout.hideNav();
        }
      };
    ...
    return App.reqres.setHandler("header", function(options) {
      if (options == null) {
        options = {};
      }
...
(function() {
  ...
  this.Dashboard.module("Components.Header", function(Header, App, Backbone, Marionette, $, _) {
    return Header.Layout = (function(superClass) {
      extend(Layout, superClass);
      ...
      Layout.prototype.template = JST['components/header/templates/header'];
      ...
      Layout.prototype.updateUserBoxText = function(text) {
        return this.ui.userBoxText.text(text);
      };

      Layout.prototype.updateNav = function(nav_item) {
        var ref;
        this.$('.current').removeClass('current');
        this.$("." + nav_item).addClass('current');
        if ((ref = App.selectedComplex) != null ? ref.isSetUp() : void 0) {
          return this.showNav();
        }
      };

      Layout.prototype.showNav = function() {
        return this.ui.nav.show();
      };

      Layout.prototype.hideNav = function() {
        return this.ui.nav.hide();
      };

      Layout.prototype.showError = function(message) {
        return this.ui.errorBox.text(message);
      };
...
(function() {
  ...
  this.Dashboard.module("Components.Login", function(Login, App, Backbone, Marionette, $, _) {
    Login.Controller = (function(superClass) {
      extend(Controller, superClass);
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.region = (options || {}).region;
        this.loginLayout = new Login.Layout({
          model: App.user
        });
        this.listenTo(this.loginLayout, 'submit', (function(_this) {
          return function() {
            _this.loginLayout.hideLoginError();
            App.user.set(_this.loginLayout.serialize());
            return App.user.validateUser();
          };
        })(this));
        this.listenTo(App.user, 'user:invalid', (function(_this) {
          return function() {
            return _this.loginLayout.showLoginError();
          };
        })(this));
        this.listenTo(App.user, 'user:valid', (function(_this) {
          return function() {
            return _this.trigger('login:success');
          };
        })(this));
        this.listenTo(this.loginLayout, 'destroy', (function(_this) {
          return function() {
            return _this.destroy();
          };
        })(this));
        return this.region.show(this.loginLayout);
      };

      return Controller;

    })(Marionette.Controller);
    return App.reqres.setHandler("login:form", function(options) {
      if (options == null) {
        options = {};
      }
      return new Login.Controller(options);
    });
  });
...
(function() {
  ...
  this.Dashboard.module("Components.Login", function(Login, App, Backbone, Marionette, $, _) {
    return Login.Layout = (function(superClass) {
      extend(Layout, superClass);
      ...
      Layout.prototype.template = JST['components/login/templates/form'];

      Layout.prototype.id = 'login';

      Layout.prototype.className = 'align-middle';
      ...
      Layout.prototype.showLoginError = function() {
        return this.ui.loginError.show();
      };

      Layout.prototype.hideLoginError = function() {
        return this.ui.loginError.hide();
      };

      Layout.include('Serialize', 'EnterPress');
...
(function() {
  ...
  this.Dashboard.module("Components.UnitList", function(UnitList, App, Backbone, Marionette, $, _) {
    UnitList.Controller = (function(superClass) {
      extend(Controller, superClass);
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.region = (options || {}).region;
        this.unitListLayout = new UnitList.Layout({
    ...
    return App.reqres.setHandler("unit:list", function(options) {
      if (options == null) {
        options = {};
      }
      return new UnitList.Controller(options);
    });
  });
...
(function() {
  ...
  this.Dashboard.module("Components.UnitList", function(UnitList, App, Backbone, Marionette, $, _) {
    UnitList.Sensor = (function(superClass) {
      ...
      Sensor.prototype.template = JST['components/unit_list/templates/sensor'];

      return Sensor;

    })(Marionette.CompositeView);
    UnitList.Unit = (function(superClass) {
      ...
      Unit.prototype.template = JST['components/unit_list/templates/unit'];

      Unit.prototype.childViewContainer = '.list-sensors';

      Unit.prototype.childView = UnitList.Sensor;
    ...
    return UnitList.Layout = (function(superClass) {
      extend(Layout, superClass);
      ...
      Layout.prototype.template = JST['components/unit_list/templates/layout'];

      Layout.prototype.childViewContainer = '.list-container';

      Layout.prototype.childView = UnitList.Unit;
...
(function() {
  ...
  this.Dashboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Company = (function(superClass) {
      ...
      Company.prototype.urlRoot = "http://dev.waterr8.com:8080/api/v1/customer/company";

      Company.prototype.initialize = function() {
        return this.on('validated:invalid', function(x) {
          return console.log('is invalid');
        });
      };

      Company.prototype.isSetUp = function() {
    ...
    return App.reqres.setHandler('entities:company', function(attrs) {
      if (attrs == null) {
        attrs = {};
      }
      return new Entities.Company(attrs);
    });
  });
...
(function() {
  ...
  this.Dashboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Complex = (function(superClass) {
      ...
      Complex.prototype.toJSON = function(options) {
        return _.omit(this.attributes, this.blacklist);
      };
      ...
      Complex.prototype.initialize = function() {
        ...
        return this.units = App.request('entities:units');
      };
    ...
    Entities.Complexes = (function(superClass) {
      extend(Complexes, superClass);

      function Complexes() {
        return Complexes.__super__.constructor.apply(this, arguments);
      }
    ...
    return App.reqres.setHandler('entities:complexes', function(options) {
      return new Entities.Complexes([], options);
    });
  });
  ...
  this.Dashboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Contact = (function(superClass) {
      ...
      Contact.prototype.methodToURL = {
        ...
        'delete': function() {
          return "http://dev.waterr8.com:8080/api/v1/customer/contact/" + this.id + "/delete";
        }
      };
    ...
    Entities.Contacts = (function(superClass) {
    ...
    App.reqres.setHandler('entities:contact', function(attrs) {
      if (attrs == null) {
        attrs = {};
      }
      return new Entities.Contact(attrs);
    });
    return App.reqres.setHandler('entities:contacts', function(attrs) {
      if (attrs == null) {
        attrs = [];
      }
      return new Entities.Contacts(attrs);
    });
  });
...
(function() {
  ...
  this.Dashboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Unit = (function(superClass) {
      extend(Unit, superClass);
      ...
      Unit.prototype.methodToURL = {
        'read': function() {
          return "http://dev.waterr8.com:8080/api/v1/customer/unit/" + this.id;
        },
        'create': function() {
          return "http://dev.waterr8.com:8080/api/v1/customer/unit/";
        },
        'update': function() {
          return "http://dev.waterr8.com:8080/api/v1/customer/unit/" + this.id + "/update";
        },
        'delete': function() {
          return "http://dev.waterr8.com:8080/api/v1/customer/unit/" + this.id + "/delete";
        }
      };

      Unit.prototype.sync = function(method, model, options) {
        options = options || {};
        options.url = model.methodToURL[method.toLowerCase()].call(this);
        return Backbone.sync(method, model, options);
      };

      Unit.prototype.blacklist = ['sensors'];
      ...
      Unit.prototype.initialize = function() {
        return console.log('init unit');
      };

      Unit.prototype.isSetUp = function() {
        return (this.get('gateway') != null) && String(this.get('gateway')).length > 0;
      };

      return Unit;

    })(Backbone.Model);
    Entities.Units = (function(superClass) {
      ...
      Units.prototype.model = Entities.Unit;

      Units.prototype.url = function() {
        return "http://dev.waterr8.com:8080/api/v1/customer/complex/" + App.selectedComplex.id + "/units";
      };

      return Units;

    })(Backbone.Collection);
    return App.reqres.setHandler('entities:units', function(units) {
      return new Entities.Units(units);
    });
  });
...
(function() {
  ...
  this.Dashboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    var tmpAuthString, tmpPass, tmpUser;
    tmpUser = 'test';
    tmpPass = 'test';
    ...
    Entities.User = (function(superClass) {
      ...
      User.prototype.url = "http://dev.waterr8.com:8080/api/v1/customer/login";

      User.prototype.setAuthString = function() {
        return this.set('auth_string', btoa("casey:casey"));
      };
          ...
          success: (function(_this) {
            return function() {
              if (_this.get('company')) {
                ...
                return _this.trigger('user:invalid');
              }
            };
          })(this),
      ...
      User.prototype.isLoggedIn = function() {
        return this.get('userValid');
      };

      return User;

    })(Backbone.Model);
    return App.reqres.setHandler('entities:user', function(attrs) {
...
(function() {
  ...
  this.Dashboard.module("Root", function(Root, App, Backbone, Marionette, $, _) {
    Root.Controller = (function(superClass) {
      extend(Controller, superClass);
      ...
      Controller.prototype.onBeforeRoute = function(route) {
        if (route !== '') {
      ...
      Controller.prototype.onAfterRoute = function(route) {
        return this.setHeader(route);
      };

      Controller.prototype.determineLandingScreen = function() {
      ...
      Controller.prototype.index = function() {
        console.log('index');
        if (App.user.isLoggedIn()) {
          return App.router.navigate(this.determineLandingScreen());
        } else {
          this.login = App.request('login:form', {
            region: App.rootView.overlay
          });
          return this.listenTo(this.login, 'login:success', (function(_this) {
            return function() {
              App.router.navigate('company-profile', {
                trigger: true
              });
              return _this.login.region.empty();
            };
          })(this));
        }
      };

      Controller.prototype.companyProfile = function() {
        console.log('company Profile');
        this.companyProfile = App.request('company:profile', {
          region: App.rootView.body
        });
        return this.listenTo(this.companyProfile, 'company:profile:success', (function(_this) {
          return function() {
            _this.companyProfile.region.empty();
      ...
      Controller.prototype.complexProfile = function() {
        ...
        if (!App.selectedComplex) {
          ...
          return this.listenTo(this.complexProfile, 'complex:profile:success', (function(_this) {
            return function() {
              _this.complexProfile.region.empty();
              return App.router.navigate('units', {
                trigger: true
              });
            };
          })(this));
      ...
      Controller.prototype.listUnits = function() {
        ...
        if (!App.selectedComplex) {
          ...
          return App.selectedComplex.units.fetch({
            success: (function(_this) {
              return function() {
                return _this.unitList = App.request('unit:list', {
                  region: App.rootView.body
                });
              };
            })(this),
            erros: (function(_this) {
              return function() {
                return alert('There was an error retrieving the unit list data.');
              };
            })(this)
          });
        }
      ...
      Controller.prototype.alerts = function() {
        return console.log('alerts');
      };

      Controller.prototype.setHeader = function(route) {
        if (this.header == null) {
          this.header = App.request('header', {
            region: App.rootView.header
          });
          return this.header.triggerMethod('navigate', route);
        } else {
          return this.header.triggerMethod('navigate', route);
        }
      };
    ...
    App.reqres.setHandler("root:view", function() {
      var view;
      view = new Root.Layout();
      view.render();
      return view;
    });
    return App.reqres.setHandler("root:controller", function() {
      return new Root.Controller();
    });
  });
...
(function() {
  ...
  this.Dashboard.module("Root", function(Root, App, Backbone, Marionette, $, _) {
    Root.Router = (function(superClass) {
      ...
      Router.prototype.before = {
        '*any': function(route) {
          return this.options.controller.onBeforeRoute(route);
        }
      };

      Router.prototype.after = {
        '*any': function(route) {
          return this.options.controller.onAfterRoute(route);
        }
      };
    ...
    return App.reqres.setHandler("root:router", function(options) {
...
(function() {
  ...
  this.Dashboard.module("Root", function(Root, App, Backbone, Marionette, $, _) {
    return Root.Layout = (function(superClass) {
      extend(Layout, superClass);
      ...
      Layout.prototype.el = '#content';

      Layout.prototype.template = JST['root/templates/layout'];
