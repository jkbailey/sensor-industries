...
window.JST["components/unit_list/templates/unit"] = function (__obj) {
  ...
  (function() {
    (function() {
      __out.push('<div class="left-side">\n  <div>\n    <div class="form-row half unit-left-first-col">\n      <label for="unit_id">Unit:</label>\n      <input type="text" id="unit_id" name="unit_id" placeholder="unit_id" class="">\n    </div>\n    <div class="form-row half unit-left-second-col">\n      <label for="num_of_beds">Bedrooms:</label>\n      <input type="text" id="num_of_beds" name="num_of_beds" placeholder="num_of_beds" class="">\n    </div>\n  </div>\n  <div>\n    <div class="form-row half unit-left-first-col">\n      <label for="num_of_tenants">Tenants:</label>\n      <input type="text" id="num_of_tenants" name="num_of_tenants" placeholder="num_of_tenants" class="">\n    </div>\n    <div class="form-row half unit-left-second-col">\n      <label for="num_of_baths">Bathrooms:</label>\n      <input type="text" id="num_of_baths" name="num_of_baths" placeholder="num_of_baths" class="">\n    </div>\n  </div>\n  <div>\n    <div class="form-row">\n      <label for="unit_node">Unit Node:</label>\n      <input type="text" id="unit_node" name="unit_node" placeholder="unit_node" class="">\n    </div>\n  </div>\n</div>\n\n<div class="right-side">\n  <h5>Sensors</h5>\n  <div class="list-sensors"></div>\n</div>\n');
...
(function() {
  ...
  this.Dashboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.Units = (function(superClass) {
      ...
      Units.prototype.localStorage = new Backbone.LocalStorage("Units");

      return Units;

    })(Backbone.Collection);
    return App.reqres.setHandler('entities:units', function(options) {
      return new Entities.Units([], options);
    });
  });
  ...
  this.Dashboard.module("Root", function(Root, App, Backbone, Marionette, $, _) {
    Root.Controller = (function(superClass) {
      ...
      Controller.prototype.listUnits = function() {
        ...
        return this.unitList = App.request('unit:list', {
          region: App.rootView.body
        });
      };
