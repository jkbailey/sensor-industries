...
(function() {
  this.Dashboard = (function(Backbone, Marionette, $) {
    ...
    App.on('before:start', function() {
      ...
      return App.company = App.request('entities:company');
    });
...
(function() {
  ...
  this.Dashboard.module("Utilities", function(Utilities, App, Backbone, Marionette, $, _) {
    return App.Router = (function(superClass) {
      ...
      Router.prototype.route = function(route, name, callback) {
        ...
        _routeFunction = (function(_this) {
          return function() {
            var controller;
            controller = _this._getController();
            controller.triggerMethod('before:route', route);
            callback.apply(_this, arguments);
            return controller.triggerMethod('after:route', route);
          };
        })(this);
        return Backbone.Router.prototype.route.call(this, route, name, _routeFunction);
      };
      ...
      Controller.prototype.initialize = function(options) {
        ...
        this.listenTo(this.companyProfileLayout, 'submit', (function(_this) {
          return function() {
            ...
            return App.company.save(_this.companyProfileLayout.serialize(), {
              success: function() {
  ...
  this.Dashboard.module("Components.CompanyProfile", function(CompanyProfile, App, Backbone, Marionette, $, _) {
    return CompanyProfile.Layout = (function(superClass) {
      ...
      Layout.prototype.onRender = function() {
        this.addStateDropdowns('.company-state', 'state');
        this.addStateDropdowns('.contact-state', 'contact[state]');
  ...
  this.Dashboard.module("Components.Header", function(Header, App, Backbone, Marionette, $, _) {
    Header.Controller = (function(superClass) {
      ...
      Controller.prototype.setUserBox = function() {
        ...
        } else if (App.company.isSetUp() && App.company.get('name')) {
...
(function() {
  ...
  this.Dashboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    Entities.Company = (function(superClass) {
      ...
      Company.prototype.blacklist = ['complexes'];

      Company.prototype.toJSON = function(options) {
        return _.omit(this.attributes, this.blacklist);
      };

      Company.prototype.localStorage = new Backbone.LocalStorage("Company");

      Company.prototype.initialize = function() {
        this.setFetchListener();
        return this.fetch();
      };

      Company.prototype.setFetchListener = function() {
        return App.execute('when:fetched', this, (function(_this) {
          return function() {
            var complexes;
            complexes = App.request('entities:complexes', {
              company_id: _this.get('id')
            });
            App.execute('when:fetched', complexes, function() {
              if (complexes.length === 0) {
                return complexes.create();
              }
            });
            complexes.fetch();
            return _this.set('complexes', complexes);
          };
        })(this));
      };
  ...
  this.Dashboard.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.User = (function(superClass) {
      ...
      User.prototype.setAuthString = function() {
        this.set('auth_string', btoa((this.get('username')) + ":" + (this.get('password'))));
        this.unset('username');
        this.unset('password');
        return this.save();
      };
      ...
      User.prototype.validateUser = function() {
        var testAuthString;
        testAuthString = btoa((this.get('username')) + ":" + (this.get('password')));
        if (testAuthString === tmpAuthString) {
          this.setAuthString();
          return this.trigger('user:valid');
        } else {
          return this.trigger('user:invalid');
        }
      };

      User.prototype.isLoggedIn = function() {
        return this.get('auth_string') != null;
      };
